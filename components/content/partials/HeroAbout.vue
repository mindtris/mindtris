    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-32 pb-10 md:pt-40">
        ...
        <div class="text-center">
          ...
          <h1 class="h1 m-0 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-6">Turning security into innovation</h1>
          <!-- Rings illustration -->
          <div class="inline-flex items-center justify-center relative">
            ...
            <div class="inline-flex [mask-image:_radial-gradient(circle_at_bottom,transparent_15%,black_70%)]">
              <img class="m-0" src="../../../images/about-illustration.svg" width="446" height="446" alt="About illustration" />
            </div>
