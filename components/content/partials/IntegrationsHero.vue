    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-32 md:pt-40">
        ...
        <div class="text-center pb-12 md:pb-20">
          ...
          <h1 class="h1 m-0 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Make Stellar uniquely yours</h1>
          <div class="max-w-3xl mx-auto">
            <p class="text-lg text-slate-400 m-0">Our landing page template works on all devices, so you only have to set it up once, and get beautiful results forever.</p>
          </div>
        </div>
