  ...
  <section class="relative">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20 border-t [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1]">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 m-0 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Join a team of makers</h2>
    ...
    <div class="max-w-[1440px] mx-auto px-4 md:px-0">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6 md:-mx-5">
        <img class="w-full m-0 aspect-[16/10] object-cover rounded-lg" src="../../../images/recruitment-01.jpg" width="352" height="220" alt="Recruitment 01" />
        <img class="w-full m-0 aspect-[16/10] object-cover rounded-lg" src="../../../images/recruitment-02.jpg" width="352" height="220" alt="Recruitment 02" />
        <img class="w-full m-0 aspect-[16/10] object-cover rounded-lg" src="../../../images/recruitment-03.jpg" width="352" height="220" alt="Recruitment 03" />
        <img class="w-full m-0 aspect-[16/10] object-cover rounded-lg" src="../../../images/recruitment-04.jpg" width="352" height="220" alt="Recruitment 04" />
      </div>
    </div>
    ...
    <div class="relative px-4 sm:px-6">
      ...
      <div class="max-w-3xl mx-auto py-12 md:py-20">
        <h3 class="h3 m-0 inline-flex bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-8 md:pb-16">Open positions</h3>
        <div class="space-y-8">

          <template v-for="item in items">
            <div>
              <h4 class="m-0 from-purple-500 inline-flex text-transparent bg-gradient-to-r from-purple-500 to-purple-200 font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-3">{{ item.area }}</h4>
              <ul class="divide-y divide-slate-800 p-0">
                <template v-for="position in item.positions">
                  <li class="flex flex-col md:flex-row flex-wrap justify-between py-5 m-0">
                    <span class="font-medium text-slate-50 mr-2 m-0">{{ position.title }}</span>
